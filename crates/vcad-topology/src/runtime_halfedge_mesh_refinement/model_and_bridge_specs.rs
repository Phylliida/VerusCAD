...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_faces_share_exactly_two_vertices_spec_symmetric_under_vertex_index_symmetry(
    m: MeshModel,
    f1: int,
    f2: int,
)
            ...
            == mesh_faces_share_exactly_two_vertices_spec(m, f2, f1),
{
    assert(
        ...
        if mesh_faces_share_exactly_two_vertices_spec(m, f1, f2) {
            let v0 = choose|v0: int| exists|v1: int| {
                &&& v0 != v1
                &&& #[trigger] mesh_faces_share_vertex_index_spec(m, f1, f2, v0)
                &&& #[trigger] mesh_faces_share_vertex_index_spec(m, f1, f2, v1)
                &&& forall|vp: int| #[trigger] mesh_faces_share_vertex_index_spec(m, f1, f2, vp)
                    ==> (vp == v0 || vp == v1)
            };
            let v1 = choose|v1: int| {
                &&& v0 != v1
                &&& #[trigger] mesh_faces_share_vertex_index_spec(m, f1, f2, v0)
                &&& #[trigger] mesh_faces_share_vertex_index_spec(m, f1, f2, v1)
                &&& forall|vp: int| #[trigger] mesh_faces_share_vertex_index_spec(m, f1, f2, vp)
            ...
            assert(v0 != v1);
            assert(mesh_faces_share_vertex_index_spec(m, f1, f2, v0));
            assert(mesh_faces_share_vertex_index_spec(m, f1, f2, v1));
            assert(
                mesh_faces_share_vertex_index_spec(m, f1, f2, v0)
                    == mesh_faces_share_vertex_index_spec(m, f2, f1, v0)
            );
            assert(
                mesh_faces_share_vertex_index_spec(m, f1, f2, v1)
                    == mesh_faces_share_vertex_index_spec(m, f2, f1, v1)
            );
            assert(mesh_faces_share_vertex_index_spec(m, f2, f1, v0));
            assert(mesh_faces_share_vertex_index_spec(m, f2, f1, v1));
            assert(
                forall|vp: int| #[trigger] mesh_faces_share_vertex_index_spec(m, f2, f1, vp)
                    ==> (vp == v0 || vp == v1)
            ) by {
                assert forall|vp: int| #[trigger] mesh_faces_share_vertex_index_spec(
                    m,
                    f2,
                    f1,
                    vp,
                ) implies (vp == v0 || vp == v1) by {
                    assert(mesh_faces_share_vertex_index_spec(m, f2, f1, vp));
                    assert(mesh_faces_share_vertex_index_spec(m, f1, f2, vp)
                        == mesh_faces_share_vertex_index_spec(m, f2, f1, vp));
                    assert(mesh_faces_share_vertex_index_spec(m, f1, f2, vp));
                    assert(vp == v0 || vp == v1);
                };
            };
            assert(mesh_faces_share_exactly_two_vertices_spec(m, f2, f1));
        }
    };
    assert(
        mesh_faces_share_exactly_two_vertices_spec(m, f2, f1)
        ...
        if mesh_faces_share_exactly_two_vertices_spec(m, f2, f1) {
            let v0 = choose|v0: int| exists|v1: int| {
                &&& v0 != v1
                &&& #[trigger] mesh_faces_share_vertex_index_spec(m, f2, f1, v0)
                &&& #[trigger] mesh_faces_share_vertex_index_spec(m, f2, f1, v1)
                &&& forall|vp: int| #[trigger] mesh_faces_share_vertex_index_spec(m, f2, f1, vp)
                    ==> (vp == v0 || vp == v1)
            };
            let v1 = choose|v1: int| {
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_faces_share_exactly_two_vertices_spec_symmetric(
    m: MeshModel,
    f1: int,
    f2: int,
)
            ...
            == mesh_faces_share_exactly_two_vertices_spec(m, f2, f1),
{
    assert(forall|v: int|
        mesh_faces_share_vertex_index_spec(m, f1, f2, v)
            == mesh_faces_share_vertex_index_spec(m, f2, f1, v)) by {
        assert forall|v: int|
            mesh_faces_share_vertex_index_spec(m, f1, f2, v)
                == mesh_faces_share_vertex_index_spec(m, f2, f1, v) by {
            lemma_mesh_faces_share_vertex_index_spec_symmetric(m, f1, f2, v);
    ...
    lemma_mesh_faces_share_exactly_two_vertices_spec_symmetric_under_vertex_index_symmetry(m, f1, f2);
}
...
{
    lemma_mesh_faces_share_exactly_two_vertices_spec_symmetric(m, f1, f2);
    lemma_mesh_faces_share_edge_spec_symmetric(m, f1, f2);
...
pub open spec fn mesh_face_pair_runtime_forbidden_intersection_policy_spec(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_face_pair_runtime_forbidden_intersection_policy_spec_symmetric_under_classifier_symmetry(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
pub proof fn lemma_mesh_non_adjacent_face_pair_forbidden_relation_implies_disjoint_boundary_and_intersection(
    ...
    ensures
        ...
        geometric_intersection_exists,
{
    assert(0 <= f1 < mesh_face_count_spec(m));
    assert(0 <= f2 < mesh_face_count_spec(m));
    assert(f1 != f2);
    assert(mesh_faces_disjoint_boundary_spec(m, f1, f2));
    assert(geometric_intersection_exists);
}

#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_disjoint_boundary_and_intersection_imply_non_adjacent_face_pair_forbidden_relation(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_non_adjacent_face_pair_forbidden_relation_iff_disjoint_boundary_and_intersection(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
        ...
        ) == (mesh_faces_disjoint_boundary_spec(m, f1, f2) && geometric_intersection_exists),
{
    ...
    assert(
        (mesh_faces_disjoint_boundary_spec(m, f1, f2) && geometric_intersection_exists) ==> mesh_non_adjacent_face_pair_forbidden_intersection_relation_spec(
            m,
            f1,
            f2,
            geometric_intersection_exists,
        ...
        if mesh_faces_disjoint_boundary_spec(m, f1, f2) && geometric_intersection_exists {
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_non_disjoint_boundary_implies_not_non_adjacent_face_pair_forbidden_relation(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
        ...
        ),
{
    ...
    assert(!(mesh_faces_disjoint_boundary_spec(m, f1, f2) && geometric_intersection_exists));
    assert(!mesh_non_adjacent_face_pair_forbidden_intersection_relation_spec(
        m,
        f1,
        f2,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_face_pair_runtime_forbidden_policy_iff_not_allowed_or_disjoint_boundary_and_intersection(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_face_pair_runtime_forbidden_policy_iff_not_allowed_contact_relation_or_disjoint_boundary_and_intersection(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_not_allowed_contact_runtime_branch_classifier_implies_runtime_forbidden_policy(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_not_allowed_contact_relation_implies_runtime_forbidden_policy(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_disjoint_boundary_and_not_runtime_forbidden_policy_imply_no_intersection(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
        ...
        !geometric_intersection_exists,
{
    ...
    if geometric_intersection_exists {
        assert(mesh_face_pair_runtime_forbidden_intersection_policy_spec(
            m,
            f1,
            f2,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_faces_shared_boundary_runtime_branch_classifier_not_runtime_forbidden_policy(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_faces_shared_boundary_allowed_contact_relation_not_runtime_forbidden_policy(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_disjoint_boundary_and_runtime_allowed_contact_imply_runtime_forbidden_policy_iff_intersection(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_disjoint_boundary_and_allowed_contact_relation_imply_runtime_forbidden_policy_iff_intersection(
    m: MeshModel,
    f1: int,
    f2: int,
    geometric_intersection_exists: bool,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_disjoint_boundary_and_allowed_contact_relation_and_no_intersection_imply_not_runtime_forbidden_policy(
    m: MeshModel,
    f1: int,
    f2: int,
)
    requires
        ...
        mesh_faces_disjoint_boundary_spec(m, f1, f2),
    ensures
        !mesh_face_pair_runtime_forbidden_intersection_policy_spec(m, f1, f2, false),
{
    lemma_mesh_disjoint_boundary_and_allowed_contact_relation_imply_runtime_forbidden_policy_iff_intersection(
        m,
        f1,
    ...
    assert(mesh_face_pair_runtime_forbidden_intersection_policy_spec(m, f1, f2, false) == false);
    assert(!mesh_face_pair_runtime_forbidden_intersection_policy_spec(m, f1, f2, false));
}

#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_disjoint_boundary_and_allowed_contact_relation_and_intersection_imply_runtime_forbidden_policy(
    m: MeshModel,
    f1: int,
    f2: int,
)
    requires
        ...
        mesh_faces_disjoint_boundary_spec(m, f1, f2),
    ensures
        mesh_face_pair_runtime_forbidden_intersection_policy_spec(m, f1, f2, true),
{
    lemma_mesh_disjoint_boundary_and_allowed_contact_relation_imply_runtime_forbidden_policy_iff_intersection(
        m,
        f1,
    ...
    assert(mesh_face_pair_runtime_forbidden_intersection_policy_spec(m, f1, f2, true) == true);
    assert(mesh_face_pair_runtime_forbidden_intersection_policy_spec(m, f1, f2, true));
}

#[cfg(verus_keep_ghost)]
pub open spec fn mesh_face_pair_bool_table_wf_spec(
    m: MeshModel,
    pair_values: Seq<Seq<bool>>,
) -> bool {
    &&& pair_values.len() == mesh_face_count_spec(m)
    &&& forall|f: int|
        0 <= f < mesh_face_count_spec(m) ==> #[trigger] pair_values[f].len() == mesh_face_count_spec(m)
}
...
#[cfg(verus_keep_ghost)]
pub open spec fn mesh_all_face_pairs_disjoint_boundary_imply_no_intersection_table_spec(
    m: MeshModel,
    geometric_intersection_exists_table: Seq<Seq<bool>>,
) -> bool {
    forall|f1: int, f2: int|
        0 <= f1 < mesh_face_count_spec(m)
            ...
            && f1 != f2
            && mesh_faces_disjoint_boundary_spec(m, f1, f2)
            ==> !#[trigger] geometric_intersection_exists_table[f1][f2]
}
                ...
                ),
{
    assert forall|f1: int, f2: int|
        0 <= f1 < mesh_face_count_spec(m)
            && 0 <= f2 < mesh_face_count_spec(m)
            && f1 != f2
            implies !mesh_non_adjacent_face_pair_forbidden_intersection_relation_spec(
            m,
            f1,
            f2,
            geometric_intersection_exists_table[f1][f2],
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_face_pairs_not_runtime_forbidden_policy_table_implies_allowed_contact_relation(
    m: MeshModel,
    geometric_intersection_exists_table: Seq<Seq<bool>>,
)
    requires
                ...
                ==> #[trigger] mesh_faces_allowed_contact_relation_spec(m, f1, f2),
{
    assert forall|f1: int, f2: int|
        0 <= f1 < mesh_face_count_spec(m)
            && 0 <= f2 < mesh_face_count_spec(m)
            && f1 != f2
            implies mesh_faces_allowed_contact_relation_spec(m, f1, f2) by {
        assert(geometric_intersection_exists_table[f1].len() == mesh_face_count_spec(m));
        assert(!mesh_face_pair_runtime_forbidden_intersection_policy_spec(
            m,
            f1,
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_face_pairs_allowed_contact_relation_table_imply_runtime_forbidden_policy_iff_non_adjacent_forbidden_relation(
    m: MeshModel,
    geometric_intersection_exists_table: Seq<Seq<bool>>,
)
    requires
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_face_pairs_not_non_adjacent_forbidden_relation_table_iff_disjoint_boundary_imply_no_intersection(
    m: MeshModel,
    geometric_intersection_exists_table: Seq<Seq<bool>>,
)
    requires
        ...
        ),
{
    assert(
        ...
        if mesh_all_face_pairs_not_non_adjacent_forbidden_relation_table_spec(
            m,
            geometric_intersection_exists_table,
        ) {
            assert forall|f1: int, f2: int|
                0 <= f1 < mesh_face_count_spec(m)
                    ...
                    && f1 != f2
                    && mesh_faces_disjoint_boundary_spec(m, f1, f2)
                    implies !#[trigger] geometric_intersection_exists_table[f1][f2] by {
                assert(geometric_intersection_exists_table[f1].len() == mesh_face_count_spec(m));
                assert(!mesh_non_adjacent_face_pair_forbidden_intersection_relation_spec(
                    m,
                    f1,
                ...
                if geometric_intersection_exists_table[f1][f2] {
                    lemma_mesh_disjoint_boundary_and_intersection_imply_non_adjacent_face_pair_forbidden_relation(
                        m,
                        f1,
                        f2,
                ...
                assert(!geometric_intersection_exists_table[f1][f2]);
            };
            assert(mesh_all_face_pairs_disjoint_boundary_imply_no_intersection_table_spec(
                m,
                geometric_intersection_exists_table,
            ));
        }
    ...
    assert(
        ...
        if mesh_all_face_pairs_disjoint_boundary_imply_no_intersection_table_spec(
            m,
            geometric_intersection_exists_table,
        ) {
            assert forall|f1: int, f2: int|
                0 <= f1 < mesh_face_count_spec(m)
                    && 0 <= f2 < mesh_face_count_spec(m)
                    && f1 != f2
                    implies !#[trigger] mesh_non_adjacent_face_pair_forbidden_intersection_relation_spec(
                    m,
                    f1,
                    f2,
                    geometric_intersection_exists_table[f1][f2],
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_face_pairs_not_runtime_forbidden_policy_table_iff_allowed_contact_relation_and_disjoint_boundary_imply_no_intersection(
    m: MeshModel,
    geometric_intersection_exists_table: Seq<Seq<bool>>,
)
    requires
                ...
                ==> !#[trigger] geometric_intersection_exists_table[f1][f2],
{
    assert forall|f1: int, f2: int|
        0 <= f1 < mesh_face_count_spec(m)
            ...
            && f1 != f2
            && mesh_faces_disjoint_boundary_spec(m, f1, f2)
            implies !geometric_intersection_exists_table[f1][f2] by {
        assert(geometric_intersection_exists_table[f1].len() == mesh_face_count_spec(m));
        assert(!mesh_face_pair_runtime_forbidden_intersection_policy_spec(
            m,
            f1,
...
#[cfg(verus_keep_ghost)]
pub open spec fn mesh_all_faces_triangle_cycles_spec(m: MeshModel) -> bool {
    &&& mesh_index_bounds_spec(m)
    &&& mesh_face_next_cycles_spec(m)
    &&& forall|f: int|
        0 <= f < mesh_face_count_spec(m) ==> #[trigger] mesh_face_cycle_witness_spec(m, f, 3)
}
        ...
        mesh_face_coplanar_witness_spec(m, vertex_positions, f, 3),
{
    ...
    assert forall|i: int, j: int, l: int, d: int|
        ...
        if d == 0 {
            assert(pd == p0);
            lemma_mesh_orient3d_any_repeated_implies_coplanar(p0, p1, p2, pd);
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_face_seed0_fixed_witness_and_triangle_cycle_imply_face_coplanar_spec(
    m: MeshModel,
    vertex_positions: Seq<vcad_math::point3::Point3>,
    f: int,
)
        ...
        mesh_face_coplanar_spec(m, vertex_positions, f),
{
    ...
    assert(mesh_face_coplanar_fixed_seed_witness_spec(m, vertex_positions, f, 3, 0));
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_faces_coplanar_seed0_fixed_witness_and_triangle_cycles_imply_all_faces_coplanar(
    m: MeshModel,
    vertex_positions: Seq<vcad_math::point3::Point3>,
)
    requires
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_faces_oriented_seed0_planes_and_triangle_cycles_imply_all_faces_coplanar(
    m: MeshModel,
    vertex_positions: Seq<vcad_math::point3::Point3>,
)
    requires
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_faces_oriented_seed0_planes_and_quad_cycles_imply_all_faces_coplanar(
    m: MeshModel,
    vertex_positions: Seq<vcad_math::point3::Point3>,
)
    requires
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_all_faces_oriented_seed0_planes_and_triangle_or_quad_cycles_imply_all_faces_coplanar(
    m: MeshModel,
    vertex_positions: Seq<vcad_math::point3::Point3>,
)
    requires
...
#[cfg(verus_keep_ghost)]
pub open spec fn mesh_runtime_all_faces_triangle_cycles_spec(m: &Mesh) -> bool {
    mesh_all_faces_triangle_cycles_spec(m@)
}
...
#[cfg(verus_keep_ghost)]
pub proof fn lemma_mesh_runtime_all_faces_coplanar_seed0_fixed_witness_and_triangle_cycles_imply_all_faces_coplanar(
    m: &Mesh,
)
    requires
        mesh_runtime_all_faces_coplanar_seed0_fixed_witness_spec(m),
